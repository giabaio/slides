...
postit: 
   random-talks: true
   social-media: true
slidesurl: "[https://gianluca.statistica.it/slides/XXX](https://gianluca.statistica.it/slides/XXX)"
thank-you: 
   show: true
   file: phoebe
...
slides-url: '`r ifelse((rmarkdown::metadata$slidesurl)!="",paste("&nbsp; | &nbsp; {{< fa circle-info >}} Slides available at ",rmarkdown::metadata$slidesurl),"")`'
