...
format:
  revealjs: 
    ...
    chalkboard: 
      buttons: false
    preview-links: auto
    theme: assets/gb-ucl-new.scss
# NB: if using the UCLSans font for the new style, needs to uncomment this
    css: assets/fonts.css
# default width/height: 1050/700; can also try 1200/800 but it's a bit narrow...
    width: 1500 
    height: 900
#    margin: 0.05
#    logo: images/ucl-new-logo.png
    footer: |
       &copy; Gianluca Baio (UCL) &nbsp; | &nbsp; [{{< fa brands linkedin >}}](https://www.linkedin.com/in/gianluca-baio/){title='Follow me on LinkedIn'} &nbsp;
...
# For the new UCL style uncomment this:
#    data-background-color: "#361a54"
...
# Section title slide {background-image="https://www.ianvisits.co.uk/articles/wp-content/uploads/2022/11/ucl-observatory-mill-hill-01.jpg" background="#361a54" background-opacity=0.5}
